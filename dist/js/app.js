(() => {
    ...
    function scrollables() {
        ...
        if (window.matchMedia("(max-width:1365px)").matches) new Scrollable(".menu__list", {
            wheelScrolling: true
        });
    }
    ...
    function sliders() {
        ...
        if (mapsSliders.length) mapsSliders.forEach((slider => {
            new Swiper(slider, {
                speed: 1e3,
                modules: [ Autoplay, Navigation ],
                spaceBetween: 16,
                ...
                navigation: {
                    prevEl: slider.closest(".maps__wrapper-slider").querySelector(".slider-btn._prev"),
                    nextEl: slider.closest(".maps__wrapper-slider").querySelector(".slider-btn._next")
                }
            });
        }));
    ...
    function fancy() {
        Oe.bind('[data-fancybox="porfolio"]', {});
        Oe.bind('[data-fancybox="works"]', {});
        Oe.bind('[data-fancybox="maps"]', {});
        Oe.bind('[data-fancybox="socials"]', {});
        Oe.bind('[data-fancybox="about"]', {});
        Oe.bind('[data-fancybox="gallery"]', {});
    }
    function removes() {
        const buttonsRemove = document.querySelectorAll(".btn-remove");
        if (buttonsRemove.length) buttonsRemove.forEach((btn => {
            btn.addEventListener("click", (() => {
    ...
    function formSelect() {
        ...
        selectButtons.forEach((btn => {
            ...
            btn.addEventListener("click", (e => {
                e.stopPropagation();
                e.preventDefault();
                if (parent.classList.contains("_select-open")) handleClose(); else handleOpen();
            }));
            function change(e) {
                console.log("change");
